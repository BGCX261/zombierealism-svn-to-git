...
has_upgrade( weaponname )
{
	...
	|| self hasWeapon(weaponname+"_aperture")
	|| self hasWeapon(weaponname+"_bayonet")
	|| self hasWeapon(weaponname+"_bigammo")
	|| self hasWeapon(weaponname+"_gl")
	|| self hasWeapon(weaponname+"_grip")
	|| self hasWeapon(weaponname+"_sawed_grip")
	|| self hasWeapon(weaponname+"_scoped_zombie")
	|| self hasWeapon(weaponname+"_telescopic"))
		has_upgrade = true;
...
add_zombie_weapon( weapon_name, hint, cost, class, ammo_cost )
{
	if(!isDefined(class))
		class = "all";
