...
setAnimArray()
{
    ...
    level.drone_animArray["auto"]   ["stand"]["down"]			 = %ai_zombie_run_attack_v3; 
    level.drone_animArray["auto"]   ["stand"]["straight"]		 = %ai_zombie_run_attack_v1; 
    level.drone_animArray["auto"]   ["stand"]["up"]			 = %ai_zombie_run_attack_v2; 
    ...
    level.drone_animArray["shoot"]   ["stand"]["down"]		 = %ai_zombie_attack_forward_v1; 
    level.drone_animArray["shoot"]   ["stand"]["straight"]	 = %ai_zombie_attack_forward_v2; 
    level.drone_animArray["shoot"]   ["stand"]["up"]			 = %ai_zombie_attack_v1; 

    level.drone_animArray["shoot"]   ["crouch"]["down"]		 = %ai_zombie_attack_v2; 
    level.drone_animArray["shoot"]   ["crouch"]["straight"]	 = %ai_zombie_attack_v3; 
    level.drone_animArray["shoot"]   ["crouch"]["up"]			 = %ai_zombie_attack_v4; 
}
*/
