...
main()
{
	...
	maps\asylum\_zombiemode_weapons::add_zombie_weapon( "mine_bouncing_betty",&"ZOMBIE_WEAPON_SATCHEL_2000", 2000 );
	...
	maps\asylum\_zombiemode_perks::init();
	maps\asylum\_zombiemode::main();		
...
{
	maps\asylum\_zombiemode_weapons::include_zombie_weapon( weapon_name );
}

include_powerup( powerup_name )
{
	maps\asylum\_zombiemode_powerups::include_zombie_powerup( powerup_name );
}
...
betty_think()
{
	...
	for(i=0;i<zombs.size;i++)
	{
		...
		{
			zombs[i] thread maps\asylum\_zombiemode_spawner::zombie_damage( "MOD_EXPLOSIVE", "none", zombs[i].origin, self.owner );
		}
	}
