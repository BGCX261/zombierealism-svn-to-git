...
ch_watch()
{
	gewehr43 = self maps\_challenges_coop::getChallengeStatus("ch_marksman_g43_1");
	m1garand = self maps\_challenges_coop::getChallengeStatus("ch_marksman_m1garand_1");
	m1carbine = self maps\_challenges_coop::getChallengeStatus("ch_marksman_m1a1_1");
	stg44 = self maps\_challenges_coop::getChallengeStatus("ch_marksman_stg44_1");
	thompson = self maps\_challenges_coop::getChallengeStatus("ch_marksman_thompson_1");
	type100smg = self maps\_challenges_coop::getChallengeStatus("ch_marksman_type100smg_1");
	mp40 = self maps\_challenges_coop::getChallengeStatus("ch_marksman_mp40_1");
	ppsh = self maps\_challenges_coop::getChallengeStatus("ch_marksman_ppsh_1");
	shotgun = self maps\_challenges_coop::getChallengeStatus("ch_marksman_shotgun_1");
	doublebarrel = self maps\_challenges_coop::getChallengeStatus("ch_marksman_dbshotty_1");
	springfield = self maps\_challenges_coop::getChallengeStatus("ch_marksman_springfield_1");
	kar98k = self maps\_challenges_coop::getChallengeStatus("ch_marksman_kar98k_1");

	while(1)
	{
		self setClientDvars("gewehr43",gewehr43,
							"m1garand",m1garand,
							"m1carbine",m1carbine,
							"stg44",stg44,
							"thompson",thompson,
