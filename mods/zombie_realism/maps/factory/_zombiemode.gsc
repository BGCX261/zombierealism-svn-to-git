...
main(init_zombie_spawner_name)
{
	...
	maps\factory\_zombiemode_radio::init();	
	maps\factory\_zombiemode_perks::init();
	maps\factory\_zombiemode_tesla::init();
	maps\factory\_zombiemode_dogs::init();
	maps\factory\_zombiemode_bowie::bowie_init();
	maps\factory\_zombiemode_cymbal_monkey::init();
	maps\factory\_zombiemode_betty::init();
	maps\factory\_zombiemode_timer::init();
	maps\factory\_zombiemode_auto_turret::init();
	
	/#
	maps\factory\_zombiemode_devgui::init();
	#/
...
#/
	...
	set_zombie_var( "penalty_no_revive_percent", 		15, 	100 );
