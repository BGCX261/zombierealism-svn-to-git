...
is_same_class( c, player )
{
	is_same = false;
	switch(c)
	{
		case "support_1":
			if(player.class_picked == "support_1")
				is_same = true;
			break;
			
		case "engineer_1":
			if(player.class_picked == "engineer_1")
				is_same = true;
			break;
		
		case "soldier_1":
		case "medic_1":
			if(player.class_picked == "soldier_1" || player.class_picked == "medic_1")
				is_same = true;
			break;
...
add_zombie_weapon( weapon_name, hint, cost, weaponVO, variation_count, class, ammo_cost  )
{
	if(!isDefined(class))
		class = "all";
...
include_zombie_weapon( weapon_name, in_box, weighting_func )
{
	...
	{
		level.weapon_weighting_funcs[weapon_name] = maps\factory\_zombiemode_weapons::default_weighting_func;
	}
	else
	{
...
init_weapons()
{
	...
	// Full Auto                                                                                	
	add_zombie_weapon( "zombie_mp40", 							&"ZOMBIE_WEAPON_MP40_1000", 				1000,	"vox_mp40",		2, "soldier_1" ); 
	add_zombie_weapon( "zombie_mp40_upgraded", 					&"ZOMBIE_WEAPON_MP40_1000", 				1000,	"vox_mp40",		2, "soldier_1" ); 
	add_zombie_weapon( "zombie_ppsh", 							&"ZOMBIE_WEAPON_PPSH_2000", 				2000,	"vox_ppsh",		5, "soldier_1" );
	add_zombie_weapon( "zombie_ppsh_upgraded", 					&"ZOMBIE_WEAPON_PPSH_2000", 				2000,	"vox_ppsh",		5, "soldier_1" );
	add_zombie_weapon( "zombie_stg44", 							&"ZOMBIE_WEAPON_STG44_1200", 				1200,	"vox_mg",		9, "soldier_1" );
	add_zombie_weapon( "zombie_stg44_upgraded", 				&"ZOMBIE_WEAPON_STG44_1200", 				1200,	"vox_mg",		9, "soldier_1" );
	add_zombie_weapon( "zombie_thompson", 						&"ZOMBIE_WEAPON_THOMPSON_1200", 			1200,	"",				0, "soldier_1" );
	add_zombie_weapon( "zombie_thompson_upgraded", 				&"ZOMBIE_WEAPON_THOMPSON_1200", 			1200,	"",				0, "soldier_1" );
	add_zombie_weapon( "zombie_type100_smg", 					&"ZOMBIE_WEAPON_TYPE100_1000", 				1000,	"",				0, "soldier_1" );
	add_zombie_weapon( "zombie_type100_smg_upgraded", 			&"ZOMBIE_WEAPON_TYPE100_1000", 				1000,	"",				0, "soldier_1" );

	add_zombie_weapon( "zombie_mp40", 							&"ZOMBIE_WEAPON_MP40_1000", 				1000,	"vox_mp40",		2, "medic_1" ); 
	add_zombie_weapon( "zombie_mp40_upgraded", 					&"ZOMBIE_WEAPON_MP40_1000", 				1000,	"vox_mp40",		2, "medic_1" ); 
	add_zombie_weapon( "zombie_ppsh", 							&"ZOMBIE_WEAPON_PPSH_2000", 				2000,	"vox_ppsh",		5, "medic_1" );
	add_zombie_weapon( "zombie_ppsh_upgraded", 					&"ZOMBIE_WEAPON_PPSH_2000", 				2000,	"vox_ppsh",		5, "medic_1" );
	add_zombie_weapon( "zombie_stg44", 							&"ZOMBIE_WEAPON_STG44_1200", 				1200,	"vox_mg",		9, "medic_1" );
	add_zombie_weapon( "zombie_stg44_upgraded", 				&"ZOMBIE_WEAPON_STG44_1200", 				1200,	"vox_mg",		9, "medic_1" );
	add_zombie_weapon( "zombie_thompson", 						&"ZOMBIE_WEAPON_THOMPSON_1200", 			1200,	"",				0, "medic_1" );
	add_zombie_weapon( "zombie_thompson_upgraded", 				&"ZOMBIE_WEAPON_THOMPSON_1200", 			1200,	"",				0, "medic_1" );
	add_zombie_weapon( "zombie_type100_smg", 					&"ZOMBIE_WEAPON_TYPE100_1000", 				1000,	"",				0, "medic_1" );
	add_zombie_weapon( "zombie_type100_smg_upgraded", 			&"ZOMBIE_WEAPON_TYPE100_1000", 				1000,	"",				0, "medic_1" );

	// Shotguns                                         	
	add_zombie_weapon( "zombie_doublebarrel", 					&"ZOMBIE_WEAPON_DOUBLEBARREL_1200", 		1200,	"vox_shotgun", 6, "engineer_1");
	add_zombie_weapon( "zombie_doublebarrel_upgraded", 			&"ZOMBIE_WEAPON_DOUBLEBARREL_1200", 		1200,	"vox_shotgun", 6, "engineer_1");
	add_zombie_weapon( "zombie_doublebarrel_sawed", 			&"ZOMBIE_WEAPON_DOUBLEBARREL_SAWED_1200", 	1200,	"vox_shotgun", 6, "engineer_1");
	add_zombie_weapon( "zombie_doublebarrel_sawed_upgraded",	&"ZOMBIE_WEAPON_DOUBLEBARREL_SAWED_1200", 	1200,	"vox_shotgun", 6, "engineer_1");
	add_zombie_weapon( "zombie_shotgun", 						&"ZOMBIE_WEAPON_SHOTGUN_1500", 				1500,	"vox_shotgun", 6, "engineer_1");
	add_zombie_weapon( "zombie_shotgun_upgraded", 				&"ZOMBIE_WEAPON_SHOTGUN_1500", 				1500,	"vox_shotgun", 6, "engineer_1");

	// Heavy Machineguns                                	
	add_zombie_weapon( "zombie_30cal", 							&"ZOMBIE_WEAPON_30CAL_3000", 				3000,	"vox_mg",		9, "support_1" );
	add_zombie_weapon( "zombie_30cal_upgraded", 				&"ZOMBIE_WEAPON_30CAL_3000", 				3000,	"vox_mg",		9, "support_1" );
	add_zombie_weapon( "zombie_bar", 							&"ZOMBIE_WEAPON_BAR_1800", 					1800,	"vox_bar",		5, "support_1" );
	add_zombie_weapon( "zombie_bar_upgraded", 					&"ZOMBIE_WEAPON_BAR_1800", 					1800,	"vox_bar",		5, "support_1" );
	add_zombie_weapon( "dp28", 									&"ZOMBIE_WEAPON_DP28_2250", 				2250,	"vox_mg" ,		9, "support_1" );
	add_zombie_weapon( "zombie_fg42", 							&"ZOMBIE_WEAPON_FG42_1500", 				1500,	"vox_mg" ,		9, "support_1" ); 
	add_zombie_weapon( "zombie_fg42_upgraded", 					&"ZOMBIE_WEAPON_FG42_1500", 				1500,	"vox_mg" ,		9, "support_1" ); 
	add_zombie_weapon( "fg42_scoped", 							&"ZOMBIE_WEAPON_FG42_S_1500", 				1500,	"vox_mg" ,		9, "support_1" ); 
	add_zombie_weapon( "zombie_mg42", 							&"ZOMBIE_WEAPON_MG42_3000", 				3000,	"vox_mg" ,		9, "support_1" ); 
	add_zombie_weapon( "zombie_mg42_upgraded", 					&"ZOMBIE_WEAPON_MG42_3000", 				3000,	"vox_mg" ,		9, "support_1" );
	add_zombie_weapon( "type99_lmg", 							&"ZOMBIE_WEAPON_TYPE99_LMG_1750", 			1750,	"vox_mg" ,		9, "support_1" ); 
	...
	// Bipods                               				
	add_zombie_weapon( "30cal_bipod", 							&"ZOMBIE_WEAPON_30CAL_BIPOD_3500", 			3500,	"vox_mg",		5, "support_1" ); 
	add_zombie_weapon( "bar_bipod", 							&"ZOMBIE_WEAPON_BAR_BIPOD_2500", 			2500,	"vox_bar",		5, "support_1" ); 
	add_zombie_weapon( "dp28_bipod", 							&"ZOMBIE_WEAPON_DP28_BIPOD_2500", 			2500,	"vox_mg",		5, "support_1" ); 
	add_zombie_weapon( "fg42_bipod", 							&"ZOMBIE_WEAPON_FG42_BIPOD_2000", 			2000,	"vox_mg",		5, "support_1" ); 
	add_zombie_weapon( "mg42_bipod", 							&"ZOMBIE_WEAPON_MG42_BIPOD_3250", 			3250,	"vox_mg",		5, "support_1"); 
	add_zombie_weapon( "type99_lmg_bipod", 						&"ZOMBIE_WEAPON_TYPE99_LMG_BIPOD_2250", 	2250,	"vox_mg",		5, "support_1" ); 
...
{	
	...
	while( 1 )
	{
		...
		{
			user thread maps\factory\_zombiemode_perks::play_no_money_perk_dialog();
			continue;	
		}
...
treasure_chest_weapon_spawn( chest, player )
{
	...
	for( i = 0; i < number_cycles; i++ )
	{
		...
		/#
		if( maps\factory\_zombiemode_tesla::tesla_gun_exists() )	
		{
...
treasure_chest_give_weapon( weapon_string )
{
	...
	if( weapon_string == "zombie_cymbal_monkey" )
	{
		...
		self maps\factory\_zombiemode_cymbal_monkey::player_give_cymbal_monkey();
			...
			*/
			...
			if( !player_has_weapon )
			{
				...
				else // not enough money
				{
					...
					player thread maps\factory\_zombiemode_perks::play_no_money_perk_dialog();
				}			
			}
...
watch_for_timeout( player, time )
{
	...
	player thread maps\factory\_zombiemode_timer::start_timer( time, "stop watching" );
...
weapon_give( weapon, is_upgrade )
{
	...
	{
		if( primaryWeapons.size >= 3 ) // he has two weapons
		{
			current_weapon = self getCurrentWeapon(); // get his current weapon
			...
			if( isdefined( current_weapon ) && primaryWeapons.size >= 3 )
			{
				if( !( weapon == "fraggrenade" || weapon == "stielhandgranate" || weapon == "molotov" || weapon == "zombie_cymbal_monkey" ) )
				{
					self TakeWeapon( current_weapon ); 
...
//		iprintlnbold("Play_Weap_VO_" + weap);
		...
		self maps\factory\_zombiemode_spawner::do_player_playdialog(plr, sound_to_play, 0.05);
	}
}
...
add_weapon_to_sound_array(vo,num)
{
	...
	for(i=0;i<player.size;i++)
	{
		...
		num = maps\factory\_zombiemode_spawner::get_number_variants(player_index + vo);
	}
//	iprintlnbold(vo);
