...
berserk_powerup()
{
	...
	self setClientDvar("g_speed",(getDvarInt("g_speed")+30));
	level.berserk = true;
	self.berserk = true;
	self.health = 200;
	self.maxhealth = 200;
...
powerup_vo(type)
{
	...
	{
		case "nuke":
			sound = "plr_" + index + "_vox_nuke";
			break;
		case "insta_kill":
			sound = "plr_" + index + "_vox_instakill";
			break;
		case "full_ammo":
			sound = "plr_" + index + "_vox_maxammo";
			break;
		case "double_points":
			sound = "plr_" + index + "_vox_2xpoints";
			break; 		
	}
...
check_for_instakill( player )
{
	...
	{
		self maps\asylum\_zombiemode_spawner::zombie_head_gib();
